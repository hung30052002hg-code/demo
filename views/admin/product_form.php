...
$actionUrl = $isEdit 
    ? BASE_URL . 'index.php?controller=admin&action=editproduct&id=' . $product['id'] 
    : BASE_URL . 'index.php?controller=admin&action=addproduct';
?>

<div class="max-w-3xl mx-auto px-4 py-12 animate-fade-in-up">
    <!-- Header -->
