                            ...
                            <tr class="hover:bg-white/1 transition-colors duration-200">
                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="flex justify-end items-center gap-3">
                                        <!-- Edit button -->
                                        <a href="<?php echo BASE_URL; ?>index.php?controller=admin&action=editproduct&id=<?php echo $product['id']; ?>" 
                                           class="text-xs text-text-gray hover:text-white transition-colors duration-200">
                                            Sửa
                                        </a>
                                        <span class="text-white/10">|</span>
                                        <!-- Delete button / form -->
                                        <form action="<?php echo BASE_URL; ?>index.php?controller=admin&action=deleteproduct" method="POST" 
