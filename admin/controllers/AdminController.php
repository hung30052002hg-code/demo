...
class AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->adminUrl = $isSeparateAdmin ? BASE_URL . 'admin/index.php?' : BASE_URL . 'index.php?controller=admin&';

        // Kiểm tra quyền admin trước khi cho phép truy cập
        if (!User::isAdmin()) {
            $_SESSION['redirect_after_login'] = $this->adminUrl . 'action=index';
    ...
    public function index()
    {
        ...
        // Render views
        require_once ROOT_PATH . 'admin/views/layouts/admin_header.php';
        require_once ROOT_PATH . 'admin/views/admin/dashboard.php';
        require_once ROOT_PATH . 'admin/views/layouts/admin_footer.php';
    }
    ...
    public function products()
    {
        ...
        // Render views
        require_once ROOT_PATH . 'admin/views/layouts/admin_header.php';
        require_once ROOT_PATH . 'admin/views/admin/products.php';
        require_once ROOT_PATH . 'admin/views/layouts/admin_footer.php';
    }
    ...
    public function addproduct()
    {
            ...
            if (empty($name) || $category_id === 0 || $price <= 0) {
                ...
                if (empty($error)) {
                    ...
                    if ($productId) {
                        ...
                        header('Location: ' . $this->adminUrl . 'action=products');
                        exit;
                    } else {
        ...
        require_once ROOT_PATH . 'admin/views/layouts/admin_header.php';
        require_once ROOT_PATH . 'admin/views/admin/product_form.php';
        require_once ROOT_PATH . 'admin/views/layouts/admin_footer.php';
    }
    ...
    public function orders()
    {
        ...
        require_once ROOT_PATH . 'admin/views/layouts/admin_header.php';
        require_once ROOT_PATH . 'admin/views/admin/orders.php';
        require_once ROOT_PATH . 'admin/views/layouts/admin_footer.php';
    }
    ...
    public function updateorderstatus()
    {
        ...
        header('Location: ' . $this->adminUrl . 'action=orders');
        exit;
    }
    ...
    public function stats()
    {
        ...
        require_once ROOT_PATH . 'admin/views/layouts/admin_header.php';
        require_once ROOT_PATH . 'admin/views/admin/stats.php';
        require_once ROOT_PATH . 'admin/views/layouts/admin_footer.php';
    }
